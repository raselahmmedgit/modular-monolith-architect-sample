...
var BlogCategory = function () {
            ...
            columns: [
                ...
                },
                {
                    ...
                    "mRender": function (data, type, row) {
                        return ' <a href="/BlogCategory/Add/' + row.id + '\" data-href=\"/BlogCategory/Add/' + row.id + '\" data-name="' + row.siteTitle + '" data-id="' + row.id + '" title="Edit" class="btn btn-warning ml-2">Edit</a>'
                            + ' <button data-href=\"/BlogCategory/Delete/' + row.id + '\" data-name="' + row.siteTitle + '" data-id="' + row.id + '" title="Delete" onclick="AppModal.DeleteCommon(this)" class="btn btn-danger ml-2">Delete</button>';
                        //return data;
    ...
    var initBlogCategory = function () {
    };

    return {
        LoadDataTables: loadDataTables,
        InitBlogCategory: initBlogCategory
    };
}();